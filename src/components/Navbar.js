...
function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-md px-6 py-4 flex justify-between items-center rounded-xl">
      ...
      <div
        className="relative flex-1 max-w-5xl hidden md:flex items-center bg-gray-100 rounded-lg px-4 py-3 
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        <button
          className="hidden sm:flex items-center border border-blue-500 text-black px-4 py-2 rounded-lg 
        ...
        >
          ...
          <span className="hidden sm:block text-blue-600 font-semibold">
            ZY
          </span>
          <img
            src={logoutIcon}
          ...
          {isLogout && (
            <div
              className="absolute left-1/2 transform -translate-x-1/2 top-full mt-1 bg-white/90 backdrop-blur-md 
              shadow-lg rounded-md py-1 px-3 text-blue-700 font-semibold text-sm"
            >
              <span>Logout</span>
            </div>
          )}
